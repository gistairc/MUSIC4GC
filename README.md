...
We have picked up all golf courses imaged by Landsat-8 between 200* and 200*. Their  profile are represented as polygons and longitude/latitude of each point is stored in the data.



The multiband satellite images of these target areas, taken by [Landsat-8](https://landsat.usgs.gov/landsat-8), were cropped into a 16 × 16 grid covering a 480 × 480 meter area as shown below. 
