...
Golf courses are good targets for automatic object detection due to their peculiar shape, world-wide distibution and uniform size. **MUSIC** for GC (**G**olf  **C**ourse) is the training and validation dataset generated by  [AIRC/AIST](http://www.airc.aist.go.jp/en/) to support  a  global survey of golf courses.  
